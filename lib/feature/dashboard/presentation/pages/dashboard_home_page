              ...
              return certificateStats.when(
                data: (stats) => Row(
                  children: [
                    Expanded(
                      child: _buildStatCard(
                        title: user.canCreateCertificates ? 'Issued' : 'Shared',
                        value: user.canCreateCertificates 
                            ? stats.issuedCertificates.toString()
                            : stats.sharedCertificates.toString(),
                        icon: user.canCreateCertificates 
    ...
    return SizedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          borderRadius: AppTheme.mediumRadius,
          child: Container(
            constraints: const BoxConstraints(minHeight: 120), // Fixed minimum height
            ...
            child: Column(
              ...
              children: [
                ...
                Flexible( // Wrap text in Flexible
                  child: Text(
                    action.title,
                    style: AppTheme.titleSmall.copyWith( // Smaller title style
                      fontWeight: FontWeight.w600,
                      color: action.color,
                    ),
                    maxLines: 2,
